...
const explorePlacesViewTab = document.getElementById('explorePlacesViewTab');
const contributeViewTab = document.getElementById('contributeViewTab');
const aboutViewTab = document.getElementById('aboutViewTab');
const listView = document.getElementById('listView');
const mapView = document.getElementById('mapView');
const explorePlacesView = document.getElementById('explorePlacesView');
